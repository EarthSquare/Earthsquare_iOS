...
extern "C"
{
	...
	void	_syncLabel();
	void	_syncImageView();
	void	_init_actionsheet();
	void	_initWithFrame_actionsheet();
	void	_initWithTitle_actionsheet();
	void	_actionSheetStyle();
	void	_actionSheetStyle_set();
	void	_addButtonWithTitle_actionsheet();
	void	_buttonTitleAtIndex_actionsheet();
	void	_destructiveButtonIndex();
	void	_destructiveButtonIndex_set();
	void	_showFromToolbar();
	void	_showInView();
	void	_showFromBarButtonItem();
	void	_showFromRect();
	void	_dismissWithClickedButtonIndex_actionsheet();
	void	_init_activityindicator();
	void	_initWithFrame_activityindicator();
	void	_initWithActivityIndicatorStyle_activityindicator();
	void	_hidesWhenStopped();
	void	_hidesWhenStopped_set();
	void	_activityIndicatorViewStyle();
	void	_activityIndicatorViewStyle_set();
	void	_color();
	void	_color_set();
	void	_init_alertview();
	void	_initWithFrame_alertview();
	void	_initWithTitle_alertview();
	void	_alertViewStyle();
	void	_alertViewStyle_set();
	void	_message();
	void	_message_set();
	void	_addButtonWithTitle_alertview();
	void	_buttonTitleAtIndex_alertview();
	void	_textFieldAtIndex();
	void	_show();
	void	_dismissWithClickedButtonIndex_alertview();
	void	_init_barbuttonitem();
	void	_initWithBarButtonSystemItem();
	void	_initWithCustomView();
	void	_initWithImage_barbutton();
	void	_initWithTitle_style();
	void	_initWithImage_landscape();
	void	_action();
	void	_action_set();
	void	_style();
	void	_style_set();
	void	_possibleTitles();
	void	_possibleTitles_set();
	void	_width();
	void	_width_set();
	void	_customView();
	void	_customView_set();
	void	_backButtonBackgroundImageForState();
	void	_setBackButtonBackgroundImage();
	void	_backButtonTitlePositionAdjustmentForBarMetrics();
	void	_setBackButtonTitlePositionAdjustment();
	void	_backButtonBackgroundVerticalPositionAdjustmentForBarMetrics();
	void	_setBackButtonBackgroundVerticalPositionAdjustment();
	void	_backgroundVerticalPositionAdjustmentForBarMetrics();
	void	_setBackgroundVerticalPositionAdjustment();
	void	_backgroundImageForState_barbutton();
	void	_setBackgroundImage_control();
	void	_backgroundImageForState_style();
	void	_setBackgroundImage_style();
	void	_titlePositionAdjustmentForBarMetrics();
	void	_setTitlePositionAdjustment();
	void	_init_button();
	void	_initWithFrame_button();
	void	_buttonWithType();
	void	_titleLabel();
	void	_reversesTitleShadowWhenHighlighted();
	void	_reversesTitleShadowWhenHighlighted_set();
	void	_setTitle();
	void	_setTitleColor();
	void	_setTitleShadowColor();
	void	_titleColorForState();
	void	_titleForState();
	void	_titleShadowColorForState();
	void	_adjustsImageWhenHighlighted();
	void	_adjustsImageWhenHighlighted_set();
	void	_adjustsImageWhenDisabled();
	void	_adjustsImageWhenDisabled_set();
	void	_showsTouchWhenHighlighted();
	void	_showsTouchWhenHighlighted_set();
	void	_backgroundImageForState_button();
	void	_imageForState();
	void	_setBackgroundImage_button();
	void	_setImage();
	void	_contentEdgeInsets();
	void	_contentEdgeInsets_set();
	void	_titleEdgeInsets();
	void	_titleEdgeInsets_set();
	void	_imageEdgeInsets();
	void	_imageEdgeInsets_set();
	void	_buttonType();
	void	_currentTitle();
	void	_currentTitleColor();
	void	_currentTitleShadowColor();
	void	_currentImage();
	void	_currentBackgroundImage();
	void	_imageView();
	void	_backgroundRectForBounds();
	void	_contentRectForBounds();
	void	_titleRectForContentRect();
	void	_imageRectForContentRect();
	void	_title();
	void	_title_set();
	void	_tintColor();
	void	_tintColor_set();
	...
	void	_barStyle_set();
	void	_translucent();
	void	_translucent_set();
	void	_highlighted();
	void	_highlighted_set();
	void	_enabled();
	void	_enabled_set();
	void	_text();
	void	_text_set();
	...
	void	_textColor_set();
	void	_textAlignment();
	void	_textAlignment_set();
	void	_adjustsFontSizeToFitWidth();
	void	_adjustsFontSizeToFitWidth_set();
	void	_editing();
	void	_inputView();
	void	_inputView_set();
	void	_inputAccessoryView();
	void	_inputAccessoryView_set();
	void	_visible();
	void	_numberOfButtons();
	void	_cancelButtonIndex();
	void	_cancelButtonIndex_set();
	void	_firstOtherButtonIndex();
	void	_thumbTintColor();
	void	_thumbTintColor_set();
	void	_startAnimating();
	void	_stopAnimating();
	void	_isAnimating();
	void	_init_control();
	void	_initWithFrame_control();
	void	_sendActionsForControlEvents();
	void	_addActionForControlEvents();
	void	_removeActionForControlEvents();
	void	_actionsForControlEvents();
	void	_allControlEvents();
	void	_state();
	void	_selected();
	void	_selected_set();
	void	_contentVerticalAlignment();
	void	_contentVerticalAlignment_set();
	void	_contentHorizontalAlignment();
	void	_contentHorizontalAlignment_set();
	void	_init_datepicker();
	void	_initWithFrame_datepicker();
	void	_date();
	void	_date_set();
	void	_setDate();
	void	_timeZone();
	void	_timeZone_set();
	void	_datePickerMode();
	void	_datePickerMode_set();
	void	_maximumDate();
	void	_maximumDate_set();
	void	_minimumDate();
	void	_minimumDate_set();
	void	_minuteInterval();
	void	_minuteInterval_set();
	void	_countDownDuration();
	void	_countDownDuration_set();
	void	_syncToolbar();
	void	_syncNavbar();
	void	_init_imageview();
	void	_initWithFrame_imageview();
	void	_initWithImage_imageview();
	void	_initWithImageHighlightedImage();
	void	_image();
	void	_image_set();
	void	_highlightedImage();
	void	_highlightedImage_set();
	void	_animationImages();
	void	_animationImages_set();
	void	_highlightedAnimationImages();
	void	_highlightedAnimationImages_set();
	void	_animationDuration();
	void	_animationDuration_set();
	void	_animationRepeatCount();
	void	_animationRepeatCount_set();
	void	_init_label();
	void	_initWithFrame_label();
	void	_lineBreakMode();
	void	_lineBreakMode_set();
	void	_adjustsLetterSpacingToFitWidth();
	void	_adjustsLetterSpacingToFitWidth_set();
	void	_baselineAdjustment();
	void	_baselineAdjustment_set();
	void	_minimumScaleFactor();
	void	_minimumScaleFactor_set();
	void	_numberOfLines();
	void	_numberOfLines_set();
	void	_highlightedTextColor();
	void	_highlightedTextColor_set();
	void	_shadowColor();
	void	_shadowColor_set();
	void	_shadowOffset();
	void	_shadowOffset_set();
	void	_textRectForBounds_label();
	void	_drawTextInRect_label();
	void	_preferredMaxLayoutWidth();
	void	_preferredMaxLayoutWidth_set();
	void	_init_navigationbar();
	void	_initWithFrame_navigationbar();
	void	_shadowImage();
	void	_shadowImage_set();
	void	_pushNavigationItem();
	void	_popNavigationItem();
	void	_setItems_navbar();
	void	_items_navbar();
	void	_items_navbar_set();
	void	_topItem();
	void	_backItem();
	void	_backgroundImageForBarMetrics();
	void	_setBackgroundImage_metrics();
	void	_titleVerticalPositionAdjustmentForBarMetrics();
	void	_setTitleVerticalPositionAdjustment();
	void	_titleTextAttributes();
	void	_titleTextAttributes_set();
	void	_init_navigationcontroller();
	void	_initWithRootViewController();
	void	_topViewController();
	void	_visibleViewController();
	void	_viewControllers();
	void	_viewControllers_set();
	void	_setViewControllers();
	void	_pushViewController();
	void	_popViewControllerAnimated();
	void	_popToRootViewControllerAnimated();
	void	_popToViewController();
	void	_navigationBar();
	void	_navigationBarHidden();
	void	_navigationBarHidden_set();
	void	_setNavigationBarHidden();
	void	_toolbar();
	void	_setToolbarHidden();
	void	_toolbarHidden();
	void	_toolbarHidden_set();
	void	_init_navigationitem();
	void	_initWithTitle();
	void	_prompt();
	void	_prompt_set();
	void	_backBarButtonItem();
	void	_backBarButtonItem_set();
	void	_hidesBackButton();
	void	_hidesBackButton_set();
	void	_setHidesBackButton();
	void	_leftItemsSupplementBackButton();
	void	_leftItemsSupplementBackButton_set();
	void	_titleView();
	void	_titleView_set();
	void	_leftBarButtonItems();
	void	_leftBarButtonItems_set();
	void	_leftBarButtonItem();
	void	_leftBarButtonItem_set();
	void	_rightBarButtonItems();
	void	_rightBarButtonItems_set();
	void	_rightBarButtonItem();
	void	_rightBarButtonItem_set();
	void	_setLeftBarButtonItems();
	void	_setLeftBarButtonItem();
	void	_setRightBarButtonItems();
	void	_setRightBarButtonItem();
	void	_init_pickerview();
	void	_initWithFrame_pickerview();
	void	_numberOfComponents();
	void	_numberOfRowsInComponent();
	void	_rowSizeForComponent();
	void	_reloadAllComponents();
	void	_reloadComponent();
	void	_selectRow();
	void	_selectedRow();
	void	_viewForRow();
	void	_showsSelectionIndicator();
	void	_showsSelectionIndicator_set();
	void	_init_popovercontroller();
	void	_initWithContentViewController();
	void	_contentViewController();
	void	_contentViewController_set();
	void	_setContentViewController();
	void	_popoverContentSize();
	void	_popoverContentSize_set();
	void	_setPopoverContentSize();
	void	_passthroughViews();
	void	_passthroughViews_set();
	void	_popoverVisible();
	void	_popoverArrowDirection();
	void	_presentPopoverFromRect();
	void	_presentPopoverFromBarButtonItem();
	void	_dismissPopoverAnimated();
	void	_popoverLayoutMargins();
	void	_popoverLayoutMargins_set();
	void	_init_progressview();
	void	_initWithFrame_progressview();
	void	_initWithProgressViewStyle_progressview();
	void	_progress();
	void	_progress_set();
	void	_setProgress();
	void	_progressViewStyle();
	void	_progressViewStyle_set();
	void	_progressTintColor();
	void	_progressTintColor_set();
	void	_progressImage();
	void	_progressImage_set();
	void	_trackTintColor();
	void	_trackTintColor_set();
	void	_trackImage();
	void	_trackImage_set();
	void	_init_scrollview();
	void	_initWithFrame_scrollview();
	void	_setContentOffset();
	void	_contentOffset();
	void	_contentOffset_set();
	void	_contentSize();
	void	_contentSize_set();
	void	_contentInset();
	void	_contentInset_set();
	void	_scrollEnabled();
	void	_scrollEnabled_set();
	void	_directionalLockEnabled();
	void	_directionalLockEnabled_set();
	void	_scrollsToTop();
	void	_scrollsToTop_set();
	void	_scrollRectToVisible();
	void	_pagingEnabled();
	void	_pagingEnabled_set();
	void	_bounces();
	void	_bounces_set();
	void	_alwaysBounceVertical();
	void	_alwaysBounceVertical_set();
	void	_alwaysBounceHorizontal();
	void	_alwaysBounceHorizontal_set();
	void	_decelerationRate();
	void	_decelerationRate_set();
	void	_dragging();
	void	_tracking();
	void	_decelerating();
	void	_indicatorStyle();
	void	_indicatorStyle_set();
	void	_scrollIndicatorInsets();
	void	_scrollIndicatorInsets_set();
	void	_showsHorizontalScrollIndicator();
	void	_showsHorizontalScrollIndicator_set();
	void	_showsVerticalScrollIndicator();
	void	_showsVerticalScrollIndicator_set();
	void	_flashScrollIndicators();
	void	_zoomToRect();
	void	_zoomScale();
	void	_zoomScale_set();
	void	_setZoomScale();
	void	_maximumZoomScale();
	void	_maximumZoomScale_set();
	void	_minimumZoomScale();
	void	_minimumZoomScale_set();
	void	_zoomBouncing();
	void	_zooming();
	void	_bouncesZoom();
	void	_bouncesZoom_set();
	void	_init_slider();
	void	_initWithFrame_slider();
	void	_val();
	void	_val_set();
	void	_setVal();
	void	_minimumValue();
	void	_minimumValue_set();
	void	_maximumValue();
	void	_maximumValue_set();
	void	_continuous();
	void	_continuous_set();
	void	_minimumValueImage();
	void	_minimumValueImage_set();
	void	_maximumValueImage();
	void	_maximumValueImage_set();
	void	_minimumTrackTintColor();
	void	_minimumTrackTintColor_set();
	void	_currentMinimumTrackImage();
	void	_minimumTrackImageForState();
	void	_setMinimumTrackImageForState();
	void	_maximumTrackTintColor();
	void	_maximumTrackTintColor_set();
	void	_currentMaximumTrackImage();
	void	_maximumTrackImageForState();
	void	_setMaximumTrackImageForState();
	void	_currentThumbImage();
	void	_thumbImageForState();
	void	_setThumbImageForState();
	void	_init_switch();
	void	_initWithFrame_switch();
	void	_on();
	void	_on_set();
	void	_setOn();
	void	_onTintColor();
	void	_onTintColor_set();
	void	_onImage();
	void	_onImage_set();
	void	_offImage();
	void	_offImage_set();
	void	_init_textfield();
	void	_initWithFrame_textfield();
	void	_placeholder();
	void	_placeholder_set();
	void	_minimumFontSize();
	void	_minimumFontSize_set();
	void	_clearsOnBeginEditing();
	void	_clearsOnBeginEditing_set();
	void	_clearsOnInsertion();
	void	_clearsOnInsertion_set();
	void	_borderStyle();
	void	_borderStyle_set();
	void	_background();
	void	_background_set();
	void	_disabledBackground();
	void	_disabledBackground_set();
	void	_clearButtonMode();
	void	_clearButtonMode_set();
	void	_leftView();
	void	_leftView_set();
	void	_leftViewMode();
	void	_leftViewMode_set();
	void	_rightView();
	void	_rightView_set();
	void	_rightViewMode();
	void	_rightViewMode_set();
	void	_textRectForBounds_textfield();
	void	_drawTextInRect_textfield();
	void	_placeholderRectForBounds();
	void	_drawPlaceholderInRect();
	void	_borderRectForBounds();
	void	_editingRectForBounds();
	void	_clearButtonRectForBounds();
	void	_leftViewRectForBounds();
	void	_rightViewRectForBounds();
	void	_init_textview();
	void	_initWithFrame_textview();
	void	_editable();
	void	_editable_set();
	void	_dataDetectorTypes();
	void	_dataDetectorTypes_set();
	void	_hasText();
	void	_init_toolbar();
	void	_initWithFrame_toolbar();
	void	_items_toolbar();
	void	_items_toolbar_set();
	void	_setItems_toolbar();
	void	_backgroundImageForToolbarPosition();
	void	_setBackgroundImage_pos();
	void	_shadowImageForToolbarPosition();
	void	_setShadowImage();
	void	_init_view();
	void	_initWithFrame();
	void	_backgroundColor();
	void	_backgroundColor_set();
	void	_hidden();
	void	_hidden_set();
	void	_alpha();
	void	_alpha_set();
	...
	void	_opaque_set();
	void	_clipsToBounds();
	void	_clipsToBounds_set();
	void	_clearsContextBeforeDrawing();
	void	_clearsContextBeforeDrawing_set();
	void	_userInteractionEnabled();
	void	_userInteractionEnabled_set();
	void	_multipleTouchEnabled();
	void	_multipleTouchEnabled_set();
	void	_exclusiveTouch();
	void	_exclusiveTouch_set();
	void	_frame();
	void	_frame_set();
	void	_bounds();
	void	_bounds_set();
	...
	void	_subviews();
	void	_addSubview();
	void	_bringSubviewToFront();
	void	_sendSubviewToBack();
	void	_removeFromSuperview();
	void	_insertSubviewAtIndex();
	void	_insertSubviewAboveSubview();
	void	_insertSubviewBelowSubview();
	void	_exchangeSubviewAtIndex();
	void	_isDescendantOfView();
	void	_autoresizingMask();
	void	_autoresizingMask_set();
	void	_autoresizesSubviews();
	void	_autoresizesSubviews_set();
	void	_contentMode();
	void	_contentMode_set();
	void	_sizeThatFits();
	void	_sizeToFit();
	...
	void	_setNeedsDisplayInRect();
	void	_contentScaleFactor();
	void	_contentScaleFactor_set();
	void	_animateWithDuration_1();
	void	_animateWithDuration_2();
	void	_animateWithDuration_3();
	void	_transitionWithView_1();
	void	_transitionFromView_2();
	void	_beginAnimations();
	void	_commitAnimations();
	void	_setAnimationStartDate();
	void	_setAnimationsEnabled();
	void	_setAnimationDuration();
	void	_setAnimationDelay();
	void	_setAnimationCurve();
	void	_setAnimationRepeatCount();
	void	_setAnimationRepeatAutoreverses();
	void	_setAnimationBeginsFromCurrentState();
	void	_setAnimationTransition();
	void	_areAnimationsEnabled();
	void	_viewWithTag();
	void	_convertPointToView();
	void	_convertPointFromView();
	void	_convertRectToView();
	void	_convertRectFromView();
	void	_endEditing();
	void	_syncNavitem();
	void	_init_viewcontroller();
	void	_view();
	void	_view_set();
	void	_isViewLoaded();
	void	_isMovingFromParentViewController();
	void	_isMovingToParentViewController();
	void	_isBeingPresented();
	void	_isBeingDismissed();
	void	_wantsFullScreenLayout();
	void	_wantsFullScreenLayout_set();
	void	_shouldAutorotate();
	void	_supportedInterfaceOrientations();
	void	_preferredInterfaceOrientationForPresentation();
	void	_interfaceOrientation();
	void	_attemptRotationToDeviceOrientation();
	void	_rotatingHeaderView();
	void	_rotatingFooterView();
	void	_editing_set();
	void	_setEditing();
	void	_presentViewController();
	void	_dismissViewControllerAnimated();
	void	_modalTransitionStyle();
	void	_modalTransitionStyle_set();
	void	_modalPresentationStyle();
	void	_modalPresentationStyle_set();
	void	_definesPresentationContext();
	void	_definesPresentationContext_set();
	void	_providesPresentationContextTransitionStyle();
	void	_providesPresentationContextTransitionStyle_set();
	void	_disablesAutomaticKeyboardDismissal();
	void	_presentingViewController();
	void	_presentedViewController();
	void	_parentViewController();
	void	_childViewControllers();
	void	_addChildViewController();
	void	_removeFromParentViewController();
	void	_shouldAutomaticallyForwardRotationMethods();
	void	_shouldAutomaticallyForwardAppearanceMethods();
	void	_transitionFromViewController();
	void	_beginAppearanceTransition();
	void	_endAppearanceTransition();
	void	_editButtonItem();
	void	_setToolbarItems();
	void	_toolbarItems();
	void	_toolbarItems_set();
	void	_navigationController();
	void	_navigationItem();
	void	_contentSizeForViewInPopover();
	void	_contentSizeForViewInPopover_set();
	void	_modalInPopover();
	void	_modalInPopover_set();
...
void RegisterMonoModules()
{
	...
	mono_dl_register_symbol("_release", (void*)&_release);
	mono_dl_register_symbol("_pauseUnity", (void*)&_pauseUnity);
	mono_dl_register_symbol("_init", (void*)&_init);
	mono_dl_register_symbol("_syncLabel", (void*)&_syncLabel);
	mono_dl_register_symbol("_syncImageView", (void*)&_syncImageView);
	mono_dl_register_symbol("_init_actionsheet", (void*)&_init_actionsheet);
	mono_dl_register_symbol("_initWithFrame_actionsheet", (void*)&_initWithFrame_actionsheet);
	mono_dl_register_symbol("_initWithTitle_actionsheet", (void*)&_initWithTitle_actionsheet);
	mono_dl_register_symbol("_actionSheetStyle", (void*)&_actionSheetStyle);
	mono_dl_register_symbol("_actionSheetStyle_set", (void*)&_actionSheetStyle_set);
	mono_dl_register_symbol("_addButtonWithTitle_actionsheet", (void*)&_addButtonWithTitle_actionsheet);
	mono_dl_register_symbol("_buttonTitleAtIndex_actionsheet", (void*)&_buttonTitleAtIndex_actionsheet);
	mono_dl_register_symbol("_destructiveButtonIndex", (void*)&_destructiveButtonIndex);
	mono_dl_register_symbol("_destructiveButtonIndex_set", (void*)&_destructiveButtonIndex_set);
	mono_dl_register_symbol("_showFromToolbar", (void*)&_showFromToolbar);
	mono_dl_register_symbol("_showInView", (void*)&_showInView);
	mono_dl_register_symbol("_showFromBarButtonItem", (void*)&_showFromBarButtonItem);
	mono_dl_register_symbol("_showFromRect", (void*)&_showFromRect);
	mono_dl_register_symbol("_dismissWithClickedButtonIndex_actionsheet", (void*)&_dismissWithClickedButtonIndex_actionsheet);
	mono_dl_register_symbol("_init_activityindicator", (void*)&_init_activityindicator);
	mono_dl_register_symbol("_initWithFrame_activityindicator", (void*)&_initWithFrame_activityindicator);
	mono_dl_register_symbol("_initWithActivityIndicatorStyle_activityindicator", (void*)&_initWithActivityIndicatorStyle_activityindicator);
	mono_dl_register_symbol("_hidesWhenStopped", (void*)&_hidesWhenStopped);
	mono_dl_register_symbol("_hidesWhenStopped_set", (void*)&_hidesWhenStopped_set);
	mono_dl_register_symbol("_activityIndicatorViewStyle", (void*)&_activityIndicatorViewStyle);
	mono_dl_register_symbol("_activityIndicatorViewStyle_set", (void*)&_activityIndicatorViewStyle_set);
	mono_dl_register_symbol("_color", (void*)&_color);
	mono_dl_register_symbol("_color_set", (void*)&_color_set);
	mono_dl_register_symbol("_init_alertview", (void*)&_init_alertview);
	mono_dl_register_symbol("_initWithFrame_alertview", (void*)&_initWithFrame_alertview);
	mono_dl_register_symbol("_initWithTitle_alertview", (void*)&_initWithTitle_alertview);
	mono_dl_register_symbol("_alertViewStyle", (void*)&_alertViewStyle);
	mono_dl_register_symbol("_alertViewStyle_set", (void*)&_alertViewStyle_set);
	mono_dl_register_symbol("_message", (void*)&_message);
	mono_dl_register_symbol("_message_set", (void*)&_message_set);
	mono_dl_register_symbol("_addButtonWithTitle_alertview", (void*)&_addButtonWithTitle_alertview);
	mono_dl_register_symbol("_buttonTitleAtIndex_alertview", (void*)&_buttonTitleAtIndex_alertview);
	mono_dl_register_symbol("_textFieldAtIndex", (void*)&_textFieldAtIndex);
	mono_dl_register_symbol("_show", (void*)&_show);
	mono_dl_register_symbol("_dismissWithClickedButtonIndex_alertview", (void*)&_dismissWithClickedButtonIndex_alertview);
	mono_dl_register_symbol("_init_barbuttonitem", (void*)&_init_barbuttonitem);
	mono_dl_register_symbol("_initWithBarButtonSystemItem", (void*)&_initWithBarButtonSystemItem);
	mono_dl_register_symbol("_initWithCustomView", (void*)&_initWithCustomView);
	mono_dl_register_symbol("_initWithImage_barbutton", (void*)&_initWithImage_barbutton);
	mono_dl_register_symbol("_initWithTitle_style", (void*)&_initWithTitle_style);
	mono_dl_register_symbol("_initWithImage_landscape", (void*)&_initWithImage_landscape);
	mono_dl_register_symbol("_action", (void*)&_action);
	mono_dl_register_symbol("_action_set", (void*)&_action_set);
	mono_dl_register_symbol("_style", (void*)&_style);
	mono_dl_register_symbol("_style_set", (void*)&_style_set);
	mono_dl_register_symbol("_possibleTitles", (void*)&_possibleTitles);
	mono_dl_register_symbol("_possibleTitles_set", (void*)&_possibleTitles_set);
	mono_dl_register_symbol("_width", (void*)&_width);
	mono_dl_register_symbol("_width_set", (void*)&_width_set);
	mono_dl_register_symbol("_customView", (void*)&_customView);
	mono_dl_register_symbol("_customView_set", (void*)&_customView_set);
	mono_dl_register_symbol("_backButtonBackgroundImageForState", (void*)&_backButtonBackgroundImageForState);
	mono_dl_register_symbol("_setBackButtonBackgroundImage", (void*)&_setBackButtonBackgroundImage);
	mono_dl_register_symbol("_backButtonTitlePositionAdjustmentForBarMetrics", (void*)&_backButtonTitlePositionAdjustmentForBarMetrics);
	mono_dl_register_symbol("_setBackButtonTitlePositionAdjustment", (void*)&_setBackButtonTitlePositionAdjustment);
	mono_dl_register_symbol("_backButtonBackgroundVerticalPositionAdjustmentForBarMetrics", (void*)&_backButtonBackgroundVerticalPositionAdjustmentForBarMetrics);
	mono_dl_register_symbol("_setBackButtonBackgroundVerticalPositionAdjustment", (void*)&_setBackButtonBackgroundVerticalPositionAdjustment);
	mono_dl_register_symbol("_backgroundVerticalPositionAdjustmentForBarMetrics", (void*)&_backgroundVerticalPositionAdjustmentForBarMetrics);
	mono_dl_register_symbol("_setBackgroundVerticalPositionAdjustment", (void*)&_setBackgroundVerticalPositionAdjustment);
	mono_dl_register_symbol("_backgroundImageForState_barbutton", (void*)&_backgroundImageForState_barbutton);
	mono_dl_register_symbol("_setBackgroundImage_control", (void*)&_setBackgroundImage_control);
	mono_dl_register_symbol("_backgroundImageForState_style", (void*)&_backgroundImageForState_style);
	mono_dl_register_symbol("_setBackgroundImage_style", (void*)&_setBackgroundImage_style);
	mono_dl_register_symbol("_titlePositionAdjustmentForBarMetrics", (void*)&_titlePositionAdjustmentForBarMetrics);
	mono_dl_register_symbol("_setTitlePositionAdjustment", (void*)&_setTitlePositionAdjustment);
	mono_dl_register_symbol("_init_button", (void*)&_init_button);
	mono_dl_register_symbol("_initWithFrame_button", (void*)&_initWithFrame_button);
	mono_dl_register_symbol("_buttonWithType", (void*)&_buttonWithType);
	mono_dl_register_symbol("_titleLabel", (void*)&_titleLabel);
	mono_dl_register_symbol("_reversesTitleShadowWhenHighlighted", (void*)&_reversesTitleShadowWhenHighlighted);
	mono_dl_register_symbol("_reversesTitleShadowWhenHighlighted_set", (void*)&_reversesTitleShadowWhenHighlighted_set);
	mono_dl_register_symbol("_setTitle", (void*)&_setTitle);
	mono_dl_register_symbol("_setTitleColor", (void*)&_setTitleColor);
	mono_dl_register_symbol("_setTitleShadowColor", (void*)&_setTitleShadowColor);
	mono_dl_register_symbol("_titleColorForState", (void*)&_titleColorForState);
	mono_dl_register_symbol("_titleForState", (void*)&_titleForState);
	mono_dl_register_symbol("_titleShadowColorForState", (void*)&_titleShadowColorForState);
	mono_dl_register_symbol("_adjustsImageWhenHighlighted", (void*)&_adjustsImageWhenHighlighted);
	mono_dl_register_symbol("_adjustsImageWhenHighlighted_set", (void*)&_adjustsImageWhenHighlighted_set);
	mono_dl_register_symbol("_adjustsImageWhenDisabled", (void*)&_adjustsImageWhenDisabled);
	mono_dl_register_symbol("_adjustsImageWhenDisabled_set", (void*)&_adjustsImageWhenDisabled_set);
	mono_dl_register_symbol("_showsTouchWhenHighlighted", (void*)&_showsTouchWhenHighlighted);
	mono_dl_register_symbol("_showsTouchWhenHighlighted_set", (void*)&_showsTouchWhenHighlighted_set);
	mono_dl_register_symbol("_backgroundImageForState_button", (void*)&_backgroundImageForState_button);
	mono_dl_register_symbol("_imageForState", (void*)&_imageForState);
	mono_dl_register_symbol("_setBackgroundImage_button", (void*)&_setBackgroundImage_button);
	mono_dl_register_symbol("_setImage", (void*)&_setImage);
	mono_dl_register_symbol("_contentEdgeInsets", (void*)&_contentEdgeInsets);
	mono_dl_register_symbol("_contentEdgeInsets_set", (void*)&_contentEdgeInsets_set);
	mono_dl_register_symbol("_titleEdgeInsets", (void*)&_titleEdgeInsets);
	mono_dl_register_symbol("_titleEdgeInsets_set", (void*)&_titleEdgeInsets_set);
	mono_dl_register_symbol("_imageEdgeInsets", (void*)&_imageEdgeInsets);
	mono_dl_register_symbol("_imageEdgeInsets_set", (void*)&_imageEdgeInsets_set);
	mono_dl_register_symbol("_buttonType", (void*)&_buttonType);
	mono_dl_register_symbol("_currentTitle", (void*)&_currentTitle);
	mono_dl_register_symbol("_currentTitleColor", (void*)&_currentTitleColor);
	mono_dl_register_symbol("_currentTitleShadowColor", (void*)&_currentTitleShadowColor);
	mono_dl_register_symbol("_currentImage", (void*)&_currentImage);
	mono_dl_register_symbol("_currentBackgroundImage", (void*)&_currentBackgroundImage);
	mono_dl_register_symbol("_imageView", (void*)&_imageView);
	mono_dl_register_symbol("_backgroundRectForBounds", (void*)&_backgroundRectForBounds);
	mono_dl_register_symbol("_contentRectForBounds", (void*)&_contentRectForBounds);
	mono_dl_register_symbol("_titleRectForContentRect", (void*)&_titleRectForContentRect);
	mono_dl_register_symbol("_imageRectForContentRect", (void*)&_imageRectForContentRect);
	mono_dl_register_symbol("_title", (void*)&_title);
	mono_dl_register_symbol("_title_set", (void*)&_title_set);
	mono_dl_register_symbol("_tintColor", (void*)&_tintColor);
	mono_dl_register_symbol("_tintColor_set", (void*)&_tintColor_set);
	mono_dl_register_symbol("_barStyle", (void*)&_barStyle);
	mono_dl_register_symbol("_barStyle_set", (void*)&_barStyle_set);
	mono_dl_register_symbol("_translucent", (void*)&_translucent);
	mono_dl_register_symbol("_translucent_set", (void*)&_translucent_set);
	mono_dl_register_symbol("_highlighted", (void*)&_highlighted);
	mono_dl_register_symbol("_highlighted_set", (void*)&_highlighted_set);
	mono_dl_register_symbol("_enabled", (void*)&_enabled);
	mono_dl_register_symbol("_enabled_set", (void*)&_enabled_set);
	mono_dl_register_symbol("_text", (void*)&_text);
	mono_dl_register_symbol("_text_set", (void*)&_text_set);
	mono_dl_register_symbol("_textColor", (void*)&_textColor);
	mono_dl_register_symbol("_textColor_set", (void*)&_textColor_set);
	mono_dl_register_symbol("_textAlignment", (void*)&_textAlignment);
	mono_dl_register_symbol("_textAlignment_set", (void*)&_textAlignment_set);
	mono_dl_register_symbol("_adjustsFontSizeToFitWidth", (void*)&_adjustsFontSizeToFitWidth);
	mono_dl_register_symbol("_adjustsFontSizeToFitWidth_set", (void*)&_adjustsFontSizeToFitWidth_set);
	mono_dl_register_symbol("_editing", (void*)&_editing);
	mono_dl_register_symbol("_inputView", (void*)&_inputView);
	mono_dl_register_symbol("_inputView_set", (void*)&_inputView_set);
	mono_dl_register_symbol("_inputAccessoryView", (void*)&_inputAccessoryView);
	mono_dl_register_symbol("_inputAccessoryView_set", (void*)&_inputAccessoryView_set);
	mono_dl_register_symbol("_visible", (void*)&_visible);
	mono_dl_register_symbol("_numberOfButtons", (void*)&_numberOfButtons);
	mono_dl_register_symbol("_cancelButtonIndex", (void*)&_cancelButtonIndex);
	mono_dl_register_symbol("_cancelButtonIndex_set", (void*)&_cancelButtonIndex_set);
	mono_dl_register_symbol("_firstOtherButtonIndex", (void*)&_firstOtherButtonIndex);
	mono_dl_register_symbol("_thumbTintColor", (void*)&_thumbTintColor);
	mono_dl_register_symbol("_thumbTintColor_set", (void*)&_thumbTintColor_set);
	mono_dl_register_symbol("_startAnimating", (void*)&_startAnimating);
	mono_dl_register_symbol("_stopAnimating", (void*)&_stopAnimating);
	mono_dl_register_symbol("_isAnimating", (void*)&_isAnimating);
	mono_dl_register_symbol("_init_control", (void*)&_init_control);
	mono_dl_register_symbol("_initWithFrame_control", (void*)&_initWithFrame_control);
	mono_dl_register_symbol("_sendActionsForControlEvents", (void*)&_sendActionsForControlEvents);
	mono_dl_register_symbol("_addActionForControlEvents", (void*)&_addActionForControlEvents);
	mono_dl_register_symbol("_removeActionForControlEvents", (void*)&_removeActionForControlEvents);
	mono_dl_register_symbol("_actionsForControlEvents", (void*)&_actionsForControlEvents);
	mono_dl_register_symbol("_allControlEvents", (void*)&_allControlEvents);
	mono_dl_register_symbol("_state", (void*)&_state);
	mono_dl_register_symbol("_selected", (void*)&_selected);
	mono_dl_register_symbol("_selected_set", (void*)&_selected_set);
	mono_dl_register_symbol("_contentVerticalAlignment", (void*)&_contentVerticalAlignment);
	mono_dl_register_symbol("_contentVerticalAlignment_set", (void*)&_contentVerticalAlignment_set);
	mono_dl_register_symbol("_contentHorizontalAlignment", (void*)&_contentHorizontalAlignment);
	mono_dl_register_symbol("_contentHorizontalAlignment_set", (void*)&_contentHorizontalAlignment_set);
	mono_dl_register_symbol("_init_datepicker", (void*)&_init_datepicker);
	mono_dl_register_symbol("_initWithFrame_datepicker", (void*)&_initWithFrame_datepicker);
	mono_dl_register_symbol("_date", (void*)&_date);
	mono_dl_register_symbol("_date_set", (void*)&_date_set);
	mono_dl_register_symbol("_setDate", (void*)&_setDate);
	mono_dl_register_symbol("_timeZone", (void*)&_timeZone);
	mono_dl_register_symbol("_timeZone_set", (void*)&_timeZone_set);
	mono_dl_register_symbol("_datePickerMode", (void*)&_datePickerMode);
	mono_dl_register_symbol("_datePickerMode_set", (void*)&_datePickerMode_set);
	mono_dl_register_symbol("_maximumDate", (void*)&_maximumDate);
	mono_dl_register_symbol("_maximumDate_set", (void*)&_maximumDate_set);
	mono_dl_register_symbol("_minimumDate", (void*)&_minimumDate);
	mono_dl_register_symbol("_minimumDate_set", (void*)&_minimumDate_set);
	mono_dl_register_symbol("_minuteInterval", (void*)&_minuteInterval);
	mono_dl_register_symbol("_minuteInterval_set", (void*)&_minuteInterval_set);
	mono_dl_register_symbol("_countDownDuration", (void*)&_countDownDuration);
	mono_dl_register_symbol("_countDownDuration_set", (void*)&_countDownDuration_set);
	mono_dl_register_symbol("_syncToolbar", (void*)&_syncToolbar);
	mono_dl_register_symbol("_syncNavbar", (void*)&_syncNavbar);
	mono_dl_register_symbol("_init_imageview", (void*)&_init_imageview);
	mono_dl_register_symbol("_initWithFrame_imageview", (void*)&_initWithFrame_imageview);
	mono_dl_register_symbol("_initWithImage_imageview", (void*)&_initWithImage_imageview);
	mono_dl_register_symbol("_initWithImageHighlightedImage", (void*)&_initWithImageHighlightedImage);
	mono_dl_register_symbol("_image", (void*)&_image);
	mono_dl_register_symbol("_image_set", (void*)&_image_set);
	mono_dl_register_symbol("_highlightedImage", (void*)&_highlightedImage);
	mono_dl_register_symbol("_highlightedImage_set", (void*)&_highlightedImage_set);
	mono_dl_register_symbol("_animationImages", (void*)&_animationImages);
	mono_dl_register_symbol("_animationImages_set", (void*)&_animationImages_set);
	mono_dl_register_symbol("_highlightedAnimationImages", (void*)&_highlightedAnimationImages);
	mono_dl_register_symbol("_highlightedAnimationImages_set", (void*)&_highlightedAnimationImages_set);
	mono_dl_register_symbol("_animationDuration", (void*)&_animationDuration);
	mono_dl_register_symbol("_animationDuration_set", (void*)&_animationDuration_set);
	mono_dl_register_symbol("_animationRepeatCount", (void*)&_animationRepeatCount);
	mono_dl_register_symbol("_animationRepeatCount_set", (void*)&_animationRepeatCount_set);
	mono_dl_register_symbol("_init_label", (void*)&_init_label);
	mono_dl_register_symbol("_initWithFrame_label", (void*)&_initWithFrame_label);
	mono_dl_register_symbol("_lineBreakMode", (void*)&_lineBreakMode);
	mono_dl_register_symbol("_lineBreakMode_set", (void*)&_lineBreakMode_set);
	mono_dl_register_symbol("_adjustsLetterSpacingToFitWidth", (void*)&_adjustsLetterSpacingToFitWidth);
	mono_dl_register_symbol("_adjustsLetterSpacingToFitWidth_set", (void*)&_adjustsLetterSpacingToFitWidth_set);
	mono_dl_register_symbol("_baselineAdjustment", (void*)&_baselineAdjustment);
	mono_dl_register_symbol("_baselineAdjustment_set", (void*)&_baselineAdjustment_set);
	mono_dl_register_symbol("_minimumScaleFactor", (void*)&_minimumScaleFactor);
	mono_dl_register_symbol("_minimumScaleFactor_set", (void*)&_minimumScaleFactor_set);
	mono_dl_register_symbol("_numberOfLines", (void*)&_numberOfLines);
	mono_dl_register_symbol("_numberOfLines_set", (void*)&_numberOfLines_set);
	mono_dl_register_symbol("_highlightedTextColor", (void*)&_highlightedTextColor);
	mono_dl_register_symbol("_highlightedTextColor_set", (void*)&_highlightedTextColor_set);
	mono_dl_register_symbol("_shadowColor", (void*)&_shadowColor);
	mono_dl_register_symbol("_shadowColor_set", (void*)&_shadowColor_set);
	mono_dl_register_symbol("_shadowOffset", (void*)&_shadowOffset);
	mono_dl_register_symbol("_shadowOffset_set", (void*)&_shadowOffset_set);
	mono_dl_register_symbol("_textRectForBounds_label", (void*)&_textRectForBounds_label);
	mono_dl_register_symbol("_drawTextInRect_label", (void*)&_drawTextInRect_label);
	mono_dl_register_symbol("_preferredMaxLayoutWidth", (void*)&_preferredMaxLayoutWidth);
	mono_dl_register_symbol("_preferredMaxLayoutWidth_set", (void*)&_preferredMaxLayoutWidth_set);
	mono_dl_register_symbol("_init_navigationbar", (void*)&_init_navigationbar);
	mono_dl_register_symbol("_initWithFrame_navigationbar", (void*)&_initWithFrame_navigationbar);
	mono_dl_register_symbol("_shadowImage", (void*)&_shadowImage);
	mono_dl_register_symbol("_shadowImage_set", (void*)&_shadowImage_set);
	mono_dl_register_symbol("_pushNavigationItem", (void*)&_pushNavigationItem);
	mono_dl_register_symbol("_popNavigationItem", (void*)&_popNavigationItem);
	mono_dl_register_symbol("_setItems_navbar", (void*)&_setItems_navbar);
	mono_dl_register_symbol("_items_navbar", (void*)&_items_navbar);
	mono_dl_register_symbol("_items_navbar_set", (void*)&_items_navbar_set);
	mono_dl_register_symbol("_topItem", (void*)&_topItem);
	mono_dl_register_symbol("_backItem", (void*)&_backItem);
	mono_dl_register_symbol("_backgroundImageForBarMetrics", (void*)&_backgroundImageForBarMetrics);
	mono_dl_register_symbol("_setBackgroundImage_metrics", (void*)&_setBackgroundImage_metrics);
	mono_dl_register_symbol("_titleVerticalPositionAdjustmentForBarMetrics", (void*)&_titleVerticalPositionAdjustmentForBarMetrics);
	mono_dl_register_symbol("_setTitleVerticalPositionAdjustment", (void*)&_setTitleVerticalPositionAdjustment);
	mono_dl_register_symbol("_titleTextAttributes", (void*)&_titleTextAttributes);
	mono_dl_register_symbol("_titleTextAttributes_set", (void*)&_titleTextAttributes_set);
	mono_dl_register_symbol("_init_navigationcontroller", (void*)&_init_navigationcontroller);
	mono_dl_register_symbol("_initWithRootViewController", (void*)&_initWithRootViewController);
	mono_dl_register_symbol("_topViewController", (void*)&_topViewController);
	mono_dl_register_symbol("_visibleViewController", (void*)&_visibleViewController);
	mono_dl_register_symbol("_viewControllers", (void*)&_viewControllers);
	mono_dl_register_symbol("_viewControllers_set", (void*)&_viewControllers_set);
	mono_dl_register_symbol("_setViewControllers", (void*)&_setViewControllers);
	mono_dl_register_symbol("_pushViewController", (void*)&_pushViewController);
	mono_dl_register_symbol("_popViewControllerAnimated", (void*)&_popViewControllerAnimated);
	mono_dl_register_symbol("_popToRootViewControllerAnimated", (void*)&_popToRootViewControllerAnimated);
	mono_dl_register_symbol("_popToViewController", (void*)&_popToViewController);
	mono_dl_register_symbol("_navigationBar", (void*)&_navigationBar);
	mono_dl_register_symbol("_navigationBarHidden", (void*)&_navigationBarHidden);
	mono_dl_register_symbol("_navigationBarHidden_set", (void*)&_navigationBarHidden_set);
	mono_dl_register_symbol("_setNavigationBarHidden", (void*)&_setNavigationBarHidden);
	mono_dl_register_symbol("_toolbar", (void*)&_toolbar);
	mono_dl_register_symbol("_setToolbarHidden", (void*)&_setToolbarHidden);
	mono_dl_register_symbol("_toolbarHidden", (void*)&_toolbarHidden);
	mono_dl_register_symbol("_toolbarHidden_set", (void*)&_toolbarHidden_set);
	mono_dl_register_symbol("_init_navigationitem", (void*)&_init_navigationitem);
	mono_dl_register_symbol("_initWithTitle", (void*)&_initWithTitle);
	mono_dl_register_symbol("_prompt", (void*)&_prompt);
	mono_dl_register_symbol("_prompt_set", (void*)&_prompt_set);
	mono_dl_register_symbol("_backBarButtonItem", (void*)&_backBarButtonItem);
	mono_dl_register_symbol("_backBarButtonItem_set", (void*)&_backBarButtonItem_set);
	mono_dl_register_symbol("_hidesBackButton", (void*)&_hidesBackButton);
	mono_dl_register_symbol("_hidesBackButton_set", (void*)&_hidesBackButton_set);
	mono_dl_register_symbol("_setHidesBackButton", (void*)&_setHidesBackButton);
	mono_dl_register_symbol("_leftItemsSupplementBackButton", (void*)&_leftItemsSupplementBackButton);
	mono_dl_register_symbol("_leftItemsSupplementBackButton_set", (void*)&_leftItemsSupplementBackButton_set);
	mono_dl_register_symbol("_titleView", (void*)&_titleView);
	mono_dl_register_symbol("_titleView_set", (void*)&_titleView_set);
	mono_dl_register_symbol("_leftBarButtonItems", (void*)&_leftBarButtonItems);
	mono_dl_register_symbol("_leftBarButtonItems_set", (void*)&_leftBarButtonItems_set);
	mono_dl_register_symbol("_leftBarButtonItem", (void*)&_leftBarButtonItem);
	mono_dl_register_symbol("_leftBarButtonItem_set", (void*)&_leftBarButtonItem_set);
	mono_dl_register_symbol("_rightBarButtonItems", (void*)&_rightBarButtonItems);
	mono_dl_register_symbol("_rightBarButtonItems_set", (void*)&_rightBarButtonItems_set);
	mono_dl_register_symbol("_rightBarButtonItem", (void*)&_rightBarButtonItem);
	mono_dl_register_symbol("_rightBarButtonItem_set", (void*)&_rightBarButtonItem_set);
	mono_dl_register_symbol("_setLeftBarButtonItems", (void*)&_setLeftBarButtonItems);
	mono_dl_register_symbol("_setLeftBarButtonItem", (void*)&_setLeftBarButtonItem);
	mono_dl_register_symbol("_setRightBarButtonItems", (void*)&_setRightBarButtonItems);
	mono_dl_register_symbol("_setRightBarButtonItem", (void*)&_setRightBarButtonItem);
	mono_dl_register_symbol("_init_pickerview", (void*)&_init_pickerview);
	mono_dl_register_symbol("_initWithFrame_pickerview", (void*)&_initWithFrame_pickerview);
	mono_dl_register_symbol("_numberOfComponents", (void*)&_numberOfComponents);
	mono_dl_register_symbol("_numberOfRowsInComponent", (void*)&_numberOfRowsInComponent);
	mono_dl_register_symbol("_rowSizeForComponent", (void*)&_rowSizeForComponent);
	mono_dl_register_symbol("_reloadAllComponents", (void*)&_reloadAllComponents);
	mono_dl_register_symbol("_reloadComponent", (void*)&_reloadComponent);
	mono_dl_register_symbol("_selectRow", (void*)&_selectRow);
	mono_dl_register_symbol("_selectedRow", (void*)&_selectedRow);
	mono_dl_register_symbol("_viewForRow", (void*)&_viewForRow);
	mono_dl_register_symbol("_showsSelectionIndicator", (void*)&_showsSelectionIndicator);
	mono_dl_register_symbol("_showsSelectionIndicator_set", (void*)&_showsSelectionIndicator_set);
	mono_dl_register_symbol("_init_popovercontroller", (void*)&_init_popovercontroller);
	mono_dl_register_symbol("_initWithContentViewController", (void*)&_initWithContentViewController);
	mono_dl_register_symbol("_contentViewController", (void*)&_contentViewController);
	mono_dl_register_symbol("_contentViewController_set", (void*)&_contentViewController_set);
	mono_dl_register_symbol("_setContentViewController", (void*)&_setContentViewController);
	mono_dl_register_symbol("_popoverContentSize", (void*)&_popoverContentSize);
	mono_dl_register_symbol("_popoverContentSize_set", (void*)&_popoverContentSize_set);
	mono_dl_register_symbol("_setPopoverContentSize", (void*)&_setPopoverContentSize);
	mono_dl_register_symbol("_passthroughViews", (void*)&_passthroughViews);
	mono_dl_register_symbol("_passthroughViews_set", (void*)&_passthroughViews_set);
	mono_dl_register_symbol("_popoverVisible", (void*)&_popoverVisible);
	mono_dl_register_symbol("_popoverArrowDirection", (void*)&_popoverArrowDirection);
	mono_dl_register_symbol("_presentPopoverFromRect", (void*)&_presentPopoverFromRect);
	mono_dl_register_symbol("_presentPopoverFromBarButtonItem", (void*)&_presentPopoverFromBarButtonItem);
	mono_dl_register_symbol("_dismissPopoverAnimated", (void*)&_dismissPopoverAnimated);
	mono_dl_register_symbol("_popoverLayoutMargins", (void*)&_popoverLayoutMargins);
	mono_dl_register_symbol("_popoverLayoutMargins_set", (void*)&_popoverLayoutMargins_set);
	mono_dl_register_symbol("_init_progressview", (void*)&_init_progressview);
	mono_dl_register_symbol("_initWithFrame_progressview", (void*)&_initWithFrame_progressview);
	mono_dl_register_symbol("_initWithProgressViewStyle_progressview", (void*)&_initWithProgressViewStyle_progressview);
	mono_dl_register_symbol("_progress", (void*)&_progress);
	mono_dl_register_symbol("_progress_set", (void*)&_progress_set);
	mono_dl_register_symbol("_setProgress", (void*)&_setProgress);
	mono_dl_register_symbol("_progressViewStyle", (void*)&_progressViewStyle);
	mono_dl_register_symbol("_progressViewStyle_set", (void*)&_progressViewStyle_set);
	mono_dl_register_symbol("_progressTintColor", (void*)&_progressTintColor);
	mono_dl_register_symbol("_progressTintColor_set", (void*)&_progressTintColor_set);
	mono_dl_register_symbol("_progressImage", (void*)&_progressImage);
	mono_dl_register_symbol("_progressImage_set", (void*)&_progressImage_set);
	mono_dl_register_symbol("_trackTintColor", (void*)&_trackTintColor);
	mono_dl_register_symbol("_trackTintColor_set", (void*)&_trackTintColor_set);
	mono_dl_register_symbol("_trackImage", (void*)&_trackImage);
	mono_dl_register_symbol("_trackImage_set", (void*)&_trackImage_set);
	mono_dl_register_symbol("_init_scrollview", (void*)&_init_scrollview);
	mono_dl_register_symbol("_initWithFrame_scrollview", (void*)&_initWithFrame_scrollview);
	mono_dl_register_symbol("_setContentOffset", (void*)&_setContentOffset);
	mono_dl_register_symbol("_contentOffset", (void*)&_contentOffset);
	mono_dl_register_symbol("_contentOffset_set", (void*)&_contentOffset_set);
	mono_dl_register_symbol("_contentSize", (void*)&_contentSize);
	mono_dl_register_symbol("_contentSize_set", (void*)&_contentSize_set);
	mono_dl_register_symbol("_contentInset", (void*)&_contentInset);
	mono_dl_register_symbol("_contentInset_set", (void*)&_contentInset_set);
	mono_dl_register_symbol("_scrollEnabled", (void*)&_scrollEnabled);
	mono_dl_register_symbol("_scrollEnabled_set", (void*)&_scrollEnabled_set);
	mono_dl_register_symbol("_directionalLockEnabled", (void*)&_directionalLockEnabled);
	mono_dl_register_symbol("_directionalLockEnabled_set", (void*)&_directionalLockEnabled_set);
	mono_dl_register_symbol("_scrollsToTop", (void*)&_scrollsToTop);
	mono_dl_register_symbol("_scrollsToTop_set", (void*)&_scrollsToTop_set);
	mono_dl_register_symbol("_scrollRectToVisible", (void*)&_scrollRectToVisible);
	mono_dl_register_symbol("_pagingEnabled", (void*)&_pagingEnabled);
	mono_dl_register_symbol("_pagingEnabled_set", (void*)&_pagingEnabled_set);
	mono_dl_register_symbol("_bounces", (void*)&_bounces);
	mono_dl_register_symbol("_bounces_set", (void*)&_bounces_set);
	mono_dl_register_symbol("_alwaysBounceVertical", (void*)&_alwaysBounceVertical);
	mono_dl_register_symbol("_alwaysBounceVertical_set", (void*)&_alwaysBounceVertical_set);
	mono_dl_register_symbol("_alwaysBounceHorizontal", (void*)&_alwaysBounceHorizontal);
	mono_dl_register_symbol("_alwaysBounceHorizontal_set", (void*)&_alwaysBounceHorizontal_set);
	mono_dl_register_symbol("_decelerationRate", (void*)&_decelerationRate);
	mono_dl_register_symbol("_decelerationRate_set", (void*)&_decelerationRate_set);
	mono_dl_register_symbol("_dragging", (void*)&_dragging);
	mono_dl_register_symbol("_tracking", (void*)&_tracking);
	mono_dl_register_symbol("_decelerating", (void*)&_decelerating);
	mono_dl_register_symbol("_indicatorStyle", (void*)&_indicatorStyle);
	mono_dl_register_symbol("_indicatorStyle_set", (void*)&_indicatorStyle_set);
	mono_dl_register_symbol("_scrollIndicatorInsets", (void*)&_scrollIndicatorInsets);
	mono_dl_register_symbol("_scrollIndicatorInsets_set", (void*)&_scrollIndicatorInsets_set);
	mono_dl_register_symbol("_showsHorizontalScrollIndicator", (void*)&_showsHorizontalScrollIndicator);
	mono_dl_register_symbol("_showsHorizontalScrollIndicator_set", (void*)&_showsHorizontalScrollIndicator_set);
	mono_dl_register_symbol("_showsVerticalScrollIndicator", (void*)&_showsVerticalScrollIndicator);
	mono_dl_register_symbol("_showsVerticalScrollIndicator_set", (void*)&_showsVerticalScrollIndicator_set);
	mono_dl_register_symbol("_flashScrollIndicators", (void*)&_flashScrollIndicators);
	mono_dl_register_symbol("_zoomToRect", (void*)&_zoomToRect);
	mono_dl_register_symbol("_zoomScale", (void*)&_zoomScale);
	mono_dl_register_symbol("_zoomScale_set", (void*)&_zoomScale_set);
	mono_dl_register_symbol("_setZoomScale", (void*)&_setZoomScale);
	mono_dl_register_symbol("_maximumZoomScale", (void*)&_maximumZoomScale);
	mono_dl_register_symbol("_maximumZoomScale_set", (void*)&_maximumZoomScale_set);
	mono_dl_register_symbol("_minimumZoomScale", (void*)&_minimumZoomScale);
	mono_dl_register_symbol("_minimumZoomScale_set", (void*)&_minimumZoomScale_set);
	mono_dl_register_symbol("_zoomBouncing", (void*)&_zoomBouncing);
	mono_dl_register_symbol("_zooming", (void*)&_zooming);
	mono_dl_register_symbol("_bouncesZoom", (void*)&_bouncesZoom);
	mono_dl_register_symbol("_bouncesZoom_set", (void*)&_bouncesZoom_set);
	mono_dl_register_symbol("_init_slider", (void*)&_init_slider);
	mono_dl_register_symbol("_initWithFrame_slider", (void*)&_initWithFrame_slider);
	mono_dl_register_symbol("_val", (void*)&_val);
	mono_dl_register_symbol("_val_set", (void*)&_val_set);
	mono_dl_register_symbol("_setVal", (void*)&_setVal);
	mono_dl_register_symbol("_minimumValue", (void*)&_minimumValue);
	mono_dl_register_symbol("_minimumValue_set", (void*)&_minimumValue_set);
	mono_dl_register_symbol("_maximumValue", (void*)&_maximumValue);
	mono_dl_register_symbol("_maximumValue_set", (void*)&_maximumValue_set);
	mono_dl_register_symbol("_continuous", (void*)&_continuous);
	mono_dl_register_symbol("_continuous_set", (void*)&_continuous_set);
	mono_dl_register_symbol("_minimumValueImage", (void*)&_minimumValueImage);
	mono_dl_register_symbol("_minimumValueImage_set", (void*)&_minimumValueImage_set);
	mono_dl_register_symbol("_maximumValueImage", (void*)&_maximumValueImage);
	mono_dl_register_symbol("_maximumValueImage_set", (void*)&_maximumValueImage_set);
	mono_dl_register_symbol("_minimumTrackTintColor", (void*)&_minimumTrackTintColor);
	mono_dl_register_symbol("_minimumTrackTintColor_set", (void*)&_minimumTrackTintColor_set);
	mono_dl_register_symbol("_currentMinimumTrackImage", (void*)&_currentMinimumTrackImage);
	mono_dl_register_symbol("_minimumTrackImageForState", (void*)&_minimumTrackImageForState);
	mono_dl_register_symbol("_setMinimumTrackImageForState", (void*)&_setMinimumTrackImageForState);
	mono_dl_register_symbol("_maximumTrackTintColor", (void*)&_maximumTrackTintColor);
	mono_dl_register_symbol("_maximumTrackTintColor_set", (void*)&_maximumTrackTintColor_set);
	mono_dl_register_symbol("_currentMaximumTrackImage", (void*)&_currentMaximumTrackImage);
	mono_dl_register_symbol("_maximumTrackImageForState", (void*)&_maximumTrackImageForState);
	mono_dl_register_symbol("_setMaximumTrackImageForState", (void*)&_setMaximumTrackImageForState);
	mono_dl_register_symbol("_currentThumbImage", (void*)&_currentThumbImage);
	mono_dl_register_symbol("_thumbImageForState", (void*)&_thumbImageForState);
	mono_dl_register_symbol("_setThumbImageForState", (void*)&_setThumbImageForState);
	mono_dl_register_symbol("_init_switch", (void*)&_init_switch);
	mono_dl_register_symbol("_initWithFrame_switch", (void*)&_initWithFrame_switch);
	mono_dl_register_symbol("_on", (void*)&_on);
	mono_dl_register_symbol("_on_set", (void*)&_on_set);
	mono_dl_register_symbol("_setOn", (void*)&_setOn);
	mono_dl_register_symbol("_onTintColor", (void*)&_onTintColor);
	mono_dl_register_symbol("_onTintColor_set", (void*)&_onTintColor_set);
	mono_dl_register_symbol("_onImage", (void*)&_onImage);
	mono_dl_register_symbol("_onImage_set", (void*)&_onImage_set);
	mono_dl_register_symbol("_offImage", (void*)&_offImage);
	mono_dl_register_symbol("_offImage_set", (void*)&_offImage_set);
	mono_dl_register_symbol("_init_textfield", (void*)&_init_textfield);
	mono_dl_register_symbol("_initWithFrame_textfield", (void*)&_initWithFrame_textfield);
	mono_dl_register_symbol("_placeholder", (void*)&_placeholder);
	mono_dl_register_symbol("_placeholder_set", (void*)&_placeholder_set);
	mono_dl_register_symbol("_minimumFontSize", (void*)&_minimumFontSize);
	mono_dl_register_symbol("_minimumFontSize_set", (void*)&_minimumFontSize_set);
	mono_dl_register_symbol("_clearsOnBeginEditing", (void*)&_clearsOnBeginEditing);
	mono_dl_register_symbol("_clearsOnBeginEditing_set", (void*)&_clearsOnBeginEditing_set);
	mono_dl_register_symbol("_clearsOnInsertion", (void*)&_clearsOnInsertion);
	mono_dl_register_symbol("_clearsOnInsertion_set", (void*)&_clearsOnInsertion_set);
	mono_dl_register_symbol("_borderStyle", (void*)&_borderStyle);
	mono_dl_register_symbol("_borderStyle_set", (void*)&_borderStyle_set);
	mono_dl_register_symbol("_background", (void*)&_background);
	mono_dl_register_symbol("_background_set", (void*)&_background_set);
	mono_dl_register_symbol("_disabledBackground", (void*)&_disabledBackground);
	mono_dl_register_symbol("_disabledBackground_set", (void*)&_disabledBackground_set);
	mono_dl_register_symbol("_clearButtonMode", (void*)&_clearButtonMode);
	mono_dl_register_symbol("_clearButtonMode_set", (void*)&_clearButtonMode_set);
	mono_dl_register_symbol("_leftView", (void*)&_leftView);
	mono_dl_register_symbol("_leftView_set", (void*)&_leftView_set);
	mono_dl_register_symbol("_leftViewMode", (void*)&_leftViewMode);
	mono_dl_register_symbol("_leftViewMode_set", (void*)&_leftViewMode_set);
	mono_dl_register_symbol("_rightView", (void*)&_rightView);
	mono_dl_register_symbol("_rightView_set", (void*)&_rightView_set);
	mono_dl_register_symbol("_rightViewMode", (void*)&_rightViewMode);
	mono_dl_register_symbol("_rightViewMode_set", (void*)&_rightViewMode_set);
	mono_dl_register_symbol("_textRectForBounds_textfield", (void*)&_textRectForBounds_textfield);
	mono_dl_register_symbol("_drawTextInRect_textfield", (void*)&_drawTextInRect_textfield);
	mono_dl_register_symbol("_placeholderRectForBounds", (void*)&_placeholderRectForBounds);
	mono_dl_register_symbol("_drawPlaceholderInRect", (void*)&_drawPlaceholderInRect);
	mono_dl_register_symbol("_borderRectForBounds", (void*)&_borderRectForBounds);
	mono_dl_register_symbol("_editingRectForBounds", (void*)&_editingRectForBounds);
	mono_dl_register_symbol("_clearButtonRectForBounds", (void*)&_clearButtonRectForBounds);
	mono_dl_register_symbol("_leftViewRectForBounds", (void*)&_leftViewRectForBounds);
	mono_dl_register_symbol("_rightViewRectForBounds", (void*)&_rightViewRectForBounds);
	mono_dl_register_symbol("_init_textview", (void*)&_init_textview);
	mono_dl_register_symbol("_initWithFrame_textview", (void*)&_initWithFrame_textview);
	mono_dl_register_symbol("_editable", (void*)&_editable);
	mono_dl_register_symbol("_editable_set", (void*)&_editable_set);
	mono_dl_register_symbol("_dataDetectorTypes", (void*)&_dataDetectorTypes);
	mono_dl_register_symbol("_dataDetectorTypes_set", (void*)&_dataDetectorTypes_set);
	mono_dl_register_symbol("_hasText", (void*)&_hasText);
	mono_dl_register_symbol("_init_toolbar", (void*)&_init_toolbar);
	mono_dl_register_symbol("_initWithFrame_toolbar", (void*)&_initWithFrame_toolbar);
	mono_dl_register_symbol("_items_toolbar", (void*)&_items_toolbar);
	mono_dl_register_symbol("_items_toolbar_set", (void*)&_items_toolbar_set);
	mono_dl_register_symbol("_setItems_toolbar", (void*)&_setItems_toolbar);
	mono_dl_register_symbol("_backgroundImageForToolbarPosition", (void*)&_backgroundImageForToolbarPosition);
	mono_dl_register_symbol("_setBackgroundImage_pos", (void*)&_setBackgroundImage_pos);
	mono_dl_register_symbol("_shadowImageForToolbarPosition", (void*)&_shadowImageForToolbarPosition);
	mono_dl_register_symbol("_setShadowImage", (void*)&_setShadowImage);
	mono_dl_register_symbol("_init_view", (void*)&_init_view);
	mono_dl_register_symbol("_initWithFrame", (void*)&_initWithFrame);
	mono_dl_register_symbol("_backgroundColor", (void*)&_backgroundColor);
	mono_dl_register_symbol("_backgroundColor_set", (void*)&_backgroundColor_set);
	mono_dl_register_symbol("_hidden", (void*)&_hidden);
	mono_dl_register_symbol("_hidden_set", (void*)&_hidden_set);
	mono_dl_register_symbol("_alpha", (void*)&_alpha);
	mono_dl_register_symbol("_alpha_set", (void*)&_alpha_set);
	mono_dl_register_symbol("_opaque", (void*)&_opaque);
	mono_dl_register_symbol("_opaque_set", (void*)&_opaque_set);
	mono_dl_register_symbol("_clipsToBounds", (void*)&_clipsToBounds);
	mono_dl_register_symbol("_clipsToBounds_set", (void*)&_clipsToBounds_set);
	mono_dl_register_symbol("_clearsContextBeforeDrawing", (void*)&_clearsContextBeforeDrawing);
	mono_dl_register_symbol("_clearsContextBeforeDrawing_set", (void*)&_clearsContextBeforeDrawing_set);
	mono_dl_register_symbol("_userInteractionEnabled", (void*)&_userInteractionEnabled);
	mono_dl_register_symbol("_userInteractionEnabled_set", (void*)&_userInteractionEnabled_set);
	mono_dl_register_symbol("_multipleTouchEnabled", (void*)&_multipleTouchEnabled);
	mono_dl_register_symbol("_multipleTouchEnabled_set", (void*)&_multipleTouchEnabled_set);
	mono_dl_register_symbol("_exclusiveTouch", (void*)&_exclusiveTouch);
	mono_dl_register_symbol("_exclusiveTouch_set", (void*)&_exclusiveTouch_set);
	mono_dl_register_symbol("_frame", (void*)&_frame);
	mono_dl_register_symbol("_frame_set", (void*)&_frame_set);
	mono_dl_register_symbol("_bounds", (void*)&_bounds);
	mono_dl_register_symbol("_bounds_set", (void*)&_bounds_set);
	mono_dl_register_symbol("_center", (void*)&_center);
	mono_dl_register_symbol("_center_set", (void*)&_center_set);
	mono_dl_register_symbol("_superview", (void*)&_superview);
	mono_dl_register_symbol("_subviews", (void*)&_subviews);
	mono_dl_register_symbol("_addSubview", (void*)&_addSubview);
	mono_dl_register_symbol("_bringSubviewToFront", (void*)&_bringSubviewToFront);
	mono_dl_register_symbol("_sendSubviewToBack", (void*)&_sendSubviewToBack);
	mono_dl_register_symbol("_removeFromSuperview", (void*)&_removeFromSuperview);
	mono_dl_register_symbol("_insertSubviewAtIndex", (void*)&_insertSubviewAtIndex);
	mono_dl_register_symbol("_insertSubviewAboveSubview", (void*)&_insertSubviewAboveSubview);
	mono_dl_register_symbol("_insertSubviewBelowSubview", (void*)&_insertSubviewBelowSubview);
	mono_dl_register_symbol("_exchangeSubviewAtIndex", (void*)&_exchangeSubviewAtIndex);
	mono_dl_register_symbol("_isDescendantOfView", (void*)&_isDescendantOfView);
	mono_dl_register_symbol("_autoresizingMask", (void*)&_autoresizingMask);
	mono_dl_register_symbol("_autoresizingMask_set", (void*)&_autoresizingMask_set);
	mono_dl_register_symbol("_autoresizesSubviews", (void*)&_autoresizesSubviews);
	mono_dl_register_symbol("_autoresizesSubviews_set", (void*)&_autoresizesSubviews_set);
	mono_dl_register_symbol("_contentMode", (void*)&_contentMode);
	mono_dl_register_symbol("_contentMode_set", (void*)&_contentMode_set);
	mono_dl_register_symbol("_sizeThatFits", (void*)&_sizeThatFits);
	mono_dl_register_symbol("_sizeToFit", (void*)&_sizeToFit);
	mono_dl_register_symbol("_layoutSubviews", (void*)&_layoutSubviews);
	mono_dl_register_symbol("_setNeedsLayout", (void*)&_setNeedsLayout);
	mono_dl_register_symbol("_layoutIfNeeded", (void*)&_layoutIfNeeded);
	mono_dl_register_symbol("_drawRect", (void*)&_drawRect);
	mono_dl_register_symbol("_setNeedsDisplay", (void*)&_setNeedsDisplay);
	mono_dl_register_symbol("_setNeedsDisplayInRect", (void*)&_setNeedsDisplayInRect);
	mono_dl_register_symbol("_contentScaleFactor", (void*)&_contentScaleFactor);
	mono_dl_register_symbol("_contentScaleFactor_set", (void*)&_contentScaleFactor_set);
	mono_dl_register_symbol("_animateWithDuration_1", (void*)&_animateWithDuration_1);
	mono_dl_register_symbol("_animateWithDuration_2", (void*)&_animateWithDuration_2);
	mono_dl_register_symbol("_animateWithDuration_3", (void*)&_animateWithDuration_3);
	mono_dl_register_symbol("_transitionWithView_1", (void*)&_transitionWithView_1);
	mono_dl_register_symbol("_transitionFromView_2", (void*)&_transitionFromView_2);
	mono_dl_register_symbol("_beginAnimations", (void*)&_beginAnimations);
	mono_dl_register_symbol("_commitAnimations", (void*)&_commitAnimations);
	mono_dl_register_symbol("_setAnimationStartDate", (void*)&_setAnimationStartDate);
	mono_dl_register_symbol("_setAnimationsEnabled", (void*)&_setAnimationsEnabled);
	mono_dl_register_symbol("_setAnimationDuration", (void*)&_setAnimationDuration);
	mono_dl_register_symbol("_setAnimationDelay", (void*)&_setAnimationDelay);
	mono_dl_register_symbol("_setAnimationCurve", (void*)&_setAnimationCurve);
	mono_dl_register_symbol("_setAnimationRepeatCount", (void*)&_setAnimationRepeatCount);
	mono_dl_register_symbol("_setAnimationRepeatAutoreverses", (void*)&_setAnimationRepeatAutoreverses);
	mono_dl_register_symbol("_setAnimationBeginsFromCurrentState", (void*)&_setAnimationBeginsFromCurrentState);
	mono_dl_register_symbol("_setAnimationTransition", (void*)&_setAnimationTransition);
	mono_dl_register_symbol("_areAnimationsEnabled", (void*)&_areAnimationsEnabled);
	mono_dl_register_symbol("_viewWithTag", (void*)&_viewWithTag);
	mono_dl_register_symbol("_convertPointToView", (void*)&_convertPointToView);
	mono_dl_register_symbol("_convertPointFromView", (void*)&_convertPointFromView);
	mono_dl_register_symbol("_convertRectToView", (void*)&_convertRectToView);
	mono_dl_register_symbol("_convertRectFromView", (void*)&_convertRectFromView);
	mono_dl_register_symbol("_endEditing", (void*)&_endEditing);
	mono_dl_register_symbol("_syncNavitem", (void*)&_syncNavitem);
	mono_dl_register_symbol("_init_viewcontroller", (void*)&_init_viewcontroller);
	mono_dl_register_symbol("_view", (void*)&_view);
	mono_dl_register_symbol("_view_set", (void*)&_view_set);
	mono_dl_register_symbol("_isViewLoaded", (void*)&_isViewLoaded);
	mono_dl_register_symbol("_isMovingFromParentViewController", (void*)&_isMovingFromParentViewController);
	mono_dl_register_symbol("_isMovingToParentViewController", (void*)&_isMovingToParentViewController);
	mono_dl_register_symbol("_isBeingPresented", (void*)&_isBeingPresented);
	mono_dl_register_symbol("_isBeingDismissed", (void*)&_isBeingDismissed);
	mono_dl_register_symbol("_wantsFullScreenLayout", (void*)&_wantsFullScreenLayout);
	mono_dl_register_symbol("_wantsFullScreenLayout_set", (void*)&_wantsFullScreenLayout_set);
	mono_dl_register_symbol("_shouldAutorotate", (void*)&_shouldAutorotate);
	mono_dl_register_symbol("_supportedInterfaceOrientations", (void*)&_supportedInterfaceOrientations);
	mono_dl_register_symbol("_preferredInterfaceOrientationForPresentation", (void*)&_preferredInterfaceOrientationForPresentation);
	mono_dl_register_symbol("_interfaceOrientation", (void*)&_interfaceOrientation);
	mono_dl_register_symbol("_attemptRotationToDeviceOrientation", (void*)&_attemptRotationToDeviceOrientation);
	mono_dl_register_symbol("_rotatingHeaderView", (void*)&_rotatingHeaderView);
	mono_dl_register_symbol("_rotatingFooterView", (void*)&_rotatingFooterView);
	mono_dl_register_symbol("_editing_set", (void*)&_editing_set);
	mono_dl_register_symbol("_setEditing", (void*)&_setEditing);
	mono_dl_register_symbol("_presentViewController", (void*)&_presentViewController);
	mono_dl_register_symbol("_dismissViewControllerAnimated", (void*)&_dismissViewControllerAnimated);
	mono_dl_register_symbol("_modalTransitionStyle", (void*)&_modalTransitionStyle);
	mono_dl_register_symbol("_modalTransitionStyle_set", (void*)&_modalTransitionStyle_set);
	mono_dl_register_symbol("_modalPresentationStyle", (void*)&_modalPresentationStyle);
	mono_dl_register_symbol("_modalPresentationStyle_set", (void*)&_modalPresentationStyle_set);
	mono_dl_register_symbol("_definesPresentationContext", (void*)&_definesPresentationContext);
	mono_dl_register_symbol("_definesPresentationContext_set", (void*)&_definesPresentationContext_set);
	mono_dl_register_symbol("_providesPresentationContextTransitionStyle", (void*)&_providesPresentationContextTransitionStyle);
	mono_dl_register_symbol("_providesPresentationContextTransitionStyle_set", (void*)&_providesPresentationContextTransitionStyle_set);
	mono_dl_register_symbol("_disablesAutomaticKeyboardDismissal", (void*)&_disablesAutomaticKeyboardDismissal);
	mono_dl_register_symbol("_presentingViewController", (void*)&_presentingViewController);
	mono_dl_register_symbol("_presentedViewController", (void*)&_presentedViewController);
	mono_dl_register_symbol("_parentViewController", (void*)&_parentViewController);
	mono_dl_register_symbol("_childViewControllers", (void*)&_childViewControllers);
	mono_dl_register_symbol("_addChildViewController", (void*)&_addChildViewController);
	mono_dl_register_symbol("_removeFromParentViewController", (void*)&_removeFromParentViewController);
	mono_dl_register_symbol("_shouldAutomaticallyForwardRotationMethods", (void*)&_shouldAutomaticallyForwardRotationMethods);
	mono_dl_register_symbol("_shouldAutomaticallyForwardAppearanceMethods", (void*)&_shouldAutomaticallyForwardAppearanceMethods);
	mono_dl_register_symbol("_transitionFromViewController", (void*)&_transitionFromViewController);
	mono_dl_register_symbol("_beginAppearanceTransition", (void*)&_beginAppearanceTransition);
	mono_dl_register_symbol("_endAppearanceTransition", (void*)&_endAppearanceTransition);
	mono_dl_register_symbol("_editButtonItem", (void*)&_editButtonItem);
	mono_dl_register_symbol("_setToolbarItems", (void*)&_setToolbarItems);
	mono_dl_register_symbol("_toolbarItems", (void*)&_toolbarItems);
	mono_dl_register_symbol("_toolbarItems_set", (void*)&_toolbarItems_set);
	mono_dl_register_symbol("_navigationController", (void*)&_navigationController);
	mono_dl_register_symbol("_navigationItem", (void*)&_navigationItem);
	mono_dl_register_symbol("_contentSizeForViewInPopover", (void*)&_contentSizeForViewInPopover);
	mono_dl_register_symbol("_contentSizeForViewInPopover_set", (void*)&_contentSizeForViewInPopover_set);
	mono_dl_register_symbol("_modalInPopover", (void*)&_modalInPopover);
	mono_dl_register_symbol("_modalInPopover_set", (void*)&_modalInPopover_set);
